...
const playersData = {
  ...
  'adam002': { name: 'آدم هاني', points: 1, absences: 0, rank: 2 },
  'ahmed003': { name: 'أحمد عطية', points: -1, absences: 1, rank: 3 },
  'retag004': { name: 'ريتاج أحمد', points: -1, absences: 1, rank: 4 },
  'omar005': { name: 'عمر عادل', points: 1, absences: 0, rank: 5 },
  ...
  'farah013': { name: 'فرح عادل', points: 1, absences: 0, rank: 13 },
  'nada014': { name: 'ندى أنور', points: 1, absences: 0, rank: 14 },
  'noreen015': { name: 'نورين محمود', points: 1, absences: 0, rank: 15 },
  'sama016': { name: 'سما وليد', points: 1, absences: 0, rank: 16 },
  'rodina017': { name: 'رودينا إسلام', points: -1, absences: 1, rank: 17 },
  'nelly018': { name: 'نيللي محمود', points: 1, absences: 0, rank: 18 },
  'taha019': { name: 'طه إسلام طه', points: 0, absences: 0, rank: 19 },
  'adel020': { name: 'عادل صبري', points: 1, absences: 0, rank: 20 },
  'mohamedsaid021': { name: 'محمد سعيد', points: 1, absences: 0, rank: 21 },
