// بيانات اللاعبين
const playersData = {
  'login001': { name: 'لوجين أحمد', points: 1, absences: 0, rank: 1 },
  'adam002': { name: 'آدم هاني', points: 3, absences: 0, rank: 2 },
  'ahmed003': { name: 'أحمد عطية', points: 1, absences: 1, rank: 3 },
  'retag004': { name: 'ريتاج أحمد', points: 0, absences: 1, rank: 4 },
  'omar005': { name: 'عمر عادل', points: 2, absences: 0, rank: 5 },
  'retag006': { name: 'ريتاج محمود', points: -1, absences: 1, rank: 6 },
  'judy007': { name: 'جودي محمود', points: -1, absences: 1, rank: 7 },
  'malak008': { name: 'ملك أيمن', points: 2, absences: 0, rank: 8 },
  'remas009': { name: 'ريماس طارق', points: 2, absences: 0, rank: 9 },
  'malak010': { name: 'ملك محمود السيد', points: 2, absences: 0, rank: 10 },
  'iten011': { name: 'إيتن فتحي', points: 3, absences: 0, rank: 11 },
  'mohamed012': { name: 'محمد عبد التام', points: 2, absences: 0, rank: 12 },
  'farah013': { name: 'فرح عادل', points: 2, absences: 0, rank: 13 },
  'nada014': { name: 'ندى أنور', points: 2, absences: 0, rank: 14 },
  'noreen015': { name: 'نورين محمود', points: 2, absences: 0, rank: 15 },
  'sama016': { name: 'سما وليد', points: 2, absences: 0, rank: 16 },
  'rodina017': { name: 'رودينا إسلام', points: -2, absences: 2, rank: 17 },
  'nelly018': { name: 'نيللي محمود', points: 2, absences: 0, rank: 18 },
  'taha019': { name: 'طه إسلام طه', points: 1, absences: 0, rank: 19 },
  'adel020': { name: 'عادل صبري', points: 1, absences: 0, rank: 20 },
  'mohamedsaid021': { name: 'محمد سعيد', points: 3, absences: 0, rank: 21 },
  'Afnan022': { name: 'أفنان عادل', points: 2, absences: 0, rank: 22 },
  'yasen000': { name: 'ياسين احمد', points: 2, absences: 0, rank: 23 },
  'Hanen787': { name: 'حنين شوقى', points: 2, absences: 0, rank: 24 },
  'Elsaed025': { name: 'السيد امام', points: 2, absences: 0, rank: 25 },
  'Basma0026': { name: 'بسمه اشرف ', points: 2, absences: 0, rank: 26 },
  'Malak0270': { name: 'ملك احمد', points: 1, absences: 0, rank: 27 },
  'Adam0028': { name: 'ادم عمرو', points: 0, absences: 1, rank: 28 },
