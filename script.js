const defaultPlayersData = {
  'iten011': { name: 'إيتن فتحي', points: 10, absences: 0, rank: 1, password: 'iten011' },
  'farah013': { name: 'فرح عادل', points: 9, absences: 0, rank: 2, password: 'farah013' },
  ...
  'Elsaed025': { name: 'السيد امام', points: 8, absences: 0, rank: 6, password: 'Elsaed025' },
  'mohamedsaid021': { name: 'محمد سعيد', points: 7, absences: 0, rank: 7, password: 'mohamedsaid021' },
  'Basma0026': { name: 'بسمه اشرف ', points: 7, absences: 1, rank: 8, password: 'Basma0026' },
  'yasen000': { name: 'ياسين احمد', points: 6, absences: 0, rank: 9, password: 'yasen000' },
  'sama016': { name: 'سما وليد', points: 6, absences: 0, rank: 10, password: 'sama016' },
  'adel020': { name: 'عادل صبري', points: 6, absences: 1, rank: 11, password: 'adel020' },
  'malak010': { name: 'ملك محمود السيد', points: 6, absences: 0, rank: 12, password: 'malak010' },
  'remas009': { name: 'ريماس طارق', points: 6, absences: 0, rank: 13, password: 'remas009' },
  'retag004': { name: 'ريتاج أحمد', points: 6, absences: 1, rank: 14, password: 'retag004' },
  'nada014': { name: 'ندى أنور', points: 5, absences: 1, rank: 15, password: 'nada014' },
  'ahmed003': { name: 'أحمد عطية', points: 5, absences: 1, rank: 16, password: 'ahmed003' },
  'login001': { name: 'لوجين أحمد', points: 5, absences: 3, rank: 17, password: 'login001' },
  'omar005': { name: 'عمر عادل', points: 5, absences: 1, rank: 18, password: 'omar005' },
  'nelly018': { name: 'نيللي محمود', points: 4, absences: 1, rank: 19, password: 'nelly018' },
  'noreen015': { name: 'نورين محمود', points: 4, absences: 1, rank: 20, password: 'noreen015' },
  'Hanen787': { name: 'حنين شوقى', points: 4, absences: 1, rank: 21, password: 'Hanen787' },
  'retag006': { name: 'ريتاج محمود', points: 4, absences: 1, rank: 22, password: 'retag006' },
  'judy007': { name: 'جودي محمود', points: 4, absences: 1, rank: 23, password: 'judy007' },
  'taha019': { name: 'طه إسلام طه', points: 4, absences: 1, rank: 24, password: 'taha019' },
  'malak008': { name: 'ملك أيمن', points: 2, absences: 2, rank: 25, password: 'malak008' },
