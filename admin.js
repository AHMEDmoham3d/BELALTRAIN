const defaultPlayersData = {
  ...
  'farah013': { name: 'فرح عادل', points: 12, absences: 0, rank: 3, password: 'farah013' },
  'Afnan022': { name: 'أفنان عادل', points: 11, absences: 0, rank: 4, password: 'Afnan022' },
  'mohamed012': { name: 'محمد عبد التام', points: 11, absences: 0, rank: 5, password: 'mohamed012' },
  'Elsaed025': { name: 'السيد امام', points: 11, absences: 0, rank: 6, password: 'Elsaed025' },
  'mohamedsaid021': { name: 'محمد سعيد', points: 13, absences: 0, rank: 7, password: 'mohamedsaid021' },
  'yasen000': { name: 'ياسين احمد', points: 11, absences: 0, rank: 8, password: 'yasen000' },
  'remas009': { name: 'ريماس طارق', points: 11, absences: 1, rank: 9, password: 'remas009' },
  'Basma0026': { name: 'بسمه اشرف ', points: 11, absences: 1, rank: 10, password: 'Basma0026' },
  'sama016': { name: 'سما وليد', points: 9, absences: 0, rank: 11, password: 'sama016' },
  'malak010': { name: 'ملك محمود السيد', points: 10, absences: 0, rank: 12, password: 'malak010' },
  'retag004': { name: 'ريتاج أحمد', points: 10, absences: 1, rank: 13, password: 'retag004' },
  'nada014': { name: 'ندى أنور', points: 9, absences: 1, rank: 14, password: 'nada014' },
  'login001': { name: 'لوجين أحمد', points: 9, absences: 3, rank: 15, password: 'login001' },
  'noreen015': { name: 'نورين محمود', points: 9, absences: 1, rank: 16, password: 'noreen015' },
  'taha019': { name: 'طه إسلام طه', points: 9, absences: 1, rank: 17, password: 'taha019' },
  'adel020': { name: 'عادل صبري', points: 8, absences: 3, rank: 18, password: 'adel020' },
  'omar005': { name: 'عمر عادل', points: 7, absences: 3, rank: 19, password: 'omar005' },
  'nelly018': { name: 'نيللي محمود', points: 8, absences: 1, rank: 20, password: 'nelly018' },
  'ahmed003': { name: 'أحمد عطية', points: 5, absences: 1, rank: 21, password: 'ahmed003' },
  'retag006': { name: 'ريتاج محمود', points: 3, absences: 3, rank: 22, password: 'retag006' },
  'judy007': { name: 'جودي محمود', points: 3, absences: 3, rank: 23, password: 'judy007' },
  'Hanen787': { name: 'حنين شوقى', points: 3, absences: 3, rank: 24, password: 'Hanen787' },
  'malak008': { name: 'ملك أيمن', points: 2, absences: 5, rank: 25, password: 'malak008' },
  'Malak0270': { name: 'ملك احمد', points: 4, absences: 5, rank: 26, password: 'Malak0270' },
  'Adam0028': { name: 'ادم عمرو', points: 0, absences: 5, rank: 27, password: 'Adam0028' },
