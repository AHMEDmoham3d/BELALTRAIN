const defaultPlayersData = {
  'farah013': { name: 'فرح عادل', points: 7, absences: 0, rank: 1, password: 'farah013' },
  'iten011': { name: 'إيتن فتحي', points: 7, absences: 0, rank: 2, password: 'iten011' },
  'adam002': { name: 'آدم هاني', points: 6, absences: 1, rank: 3, password: 'adam002' },
  'Afnan022': { name: 'أفنان عادل', points: 6, absences: 0, rank: 4, password: 'Afnan022' },
  'mohamed012': { name: 'محمد عبد التام', points: 6, absences: 0, rank: 5, password: 'mohamed012' },
  'mohamedsaid021': { name: 'محمد سعيد', points: 5, absences: 0, rank: 6, password: 'mohamedsaid021' },
  'yasen000': { name: 'ياسين احمد', points: 5, absences: 0, rank: 7, password: 'yasen000' },
  'Elsaed025': { name: 'السيد امام', points: 5, absences: 0, rank: 8, password: 'Elsaed025' },
  'sama016': { name: 'سما وليد', points: 5, absences: 0, rank: 9, password: 'sama016' },
  'nada014': { name: 'ندى أنور', points: 4, absences: 1, rank: 10, password: 'nada014' },
  'ahmed003': { name: 'أحمد عطية', points: 4, absences: 1, rank: 11, password: 'ahmed003' },
  'adel020': { name: 'عادل صبري', points: 4, absences: 1, rank: 12, password: 'adel020' },
  'malak010': { name: 'ملك محمود السيد', points: 4, absences: 0, rank: 13, password: 'malak010' },
  'nelly018': { name: 'نيللي محمود', points: 4, absences: 0, rank: 14, password: 'nelly018' },
  'noreen015': { name: 'نورين محمود', points: 4, absences: 0, rank: 15, password: 'noreen015' },
  'remas009': { name: 'ريماس طارق', points: 4, absences: 0, rank: 16, password: 'remas009' },
  'retag004': { name: 'ريتاج أحمد', points: 4, absences: 1, rank: 17, password: 'retag004' },
  'Basma0026': { name: 'بسمه اشرف ', points: 4, absences: 1, rank: 18, password: 'Basma0026' },
  'Hanen787': { name: 'حنين شوقى', points: 3, absences: 1, rank: 19, password: 'Hanen787' },
  'login001': { name: 'لوجين أحمد', points: 3, absences: 3, rank: 20, password: 'login001' },
  'omar005': { name: 'عمر عادل', points: 3, absences: 1, rank: 21, password: 'omar005' },
  'retag006': { name: 'ريتاج محمود', points: 3, absences: 1, rank: 22, password: 'retag006' },
  'malak008': { name: 'ملك أيمن', points: 2, absences: 1, rank: 23, password: 'malak008' },
  'judy007': { name: 'جودي محمود', points: 2, absences: 1, rank: 24, password: 'judy007' },
  'taha019': { name: 'طه إسلام طه', points: 2, absences: 1, rank: 25, password: 'taha019' },
  'Malak0270': { name: 'ملك احمد', points: 2, absences: 2, rank: 26, password: 'Malak0270' },
  'Adam0028': { name: 'ادم عمرو', points: 0, absences: 2, rank: 27, password: 'Adam0028' },
  'rodina017': { name: 'رودينا إسلام', points: -2, absences: 3, rank: 28, password: 'rodina017' },
